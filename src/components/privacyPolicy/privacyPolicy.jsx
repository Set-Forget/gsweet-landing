...
const PrivacyPolicy = () => {
    return (
        <div id="wrapper">
            <div id="main">
                <div className="inner">
                    <h1 id="text01">Privacy Policy</h1>
                    <p id="text07">
                        <span className="p">
                            ...
                            <p>
                                The text data collected from your Google Docs is shared with OpenAI's API for the specific purpose of leveraging its capabilities in generating summaries and creating graphs. We ensure that this data sharing is secure and limited to the stated purposes.
                            </p>
                            <br/>
