  ...
  return (
    <footer className="max-w-full bg-[#DA581A] h-[5vh]">
        <ul className='flex flex-row justify-center items-center list-style-none text-white'>
            ...
            <li  className="px-4"><Link to="/tc">Terms &amp; Conditions</Link></li>
            <li  className="px-4"><Link to="/privacy-policy">Privacy policy</Link></li>
            <li  className="px-4"><Link to="/google-disclosure">Google Disclosure</Link></li>
        </ul>
    </footer>
  )
}